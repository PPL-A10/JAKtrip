  ...
  <script>
   ...
   //         alert("aja");
     ...
     //      alert(budget);
             ...
             //       alert(obj.query.result[0].place_name);
                    ...
                    //          alert(obj.query.harga[i] + " " + sisaBudget);
                            ...
                            output = output + "<tr onclick='javascript:showRating("+obj.query.result[i].place_name+")'>";
                            output = output + "<td><img src='http://localhost/Jaktrip/assets/img/150.jpg'/></td>";
                            output = output + "<td height='20px' class='tuffyh3a'>"+obj.query.result[i].place_name+"<br><div style='font-family:Lato; font-size:14px;'>Rp "+obj.query.harga[i]+" - Indoor Play - "+obj.query.result[i].city+"</span><br>"+obj.query.hargaAngkotSebelum[i]+" (harga angkot ke halte) + "+obj.query.hargaBusway[i]+" (harga Busway) + " +obj.query.hargaAngkotSetelah[i]+" (harga Angkot ke Tempat Wisata) + "+ticketPrice+" (harga tiket)<br><br><button class='btn btn-warning' onclick=\"addTrip11('"+obj.query.result[i].place_name+"','"+obj.query.result[i].halte_name+"','"+obj.query.hargaBusway[i]+"','"+obj.query.result[i].transport_price+"','"+ticketPrice+"','"+obj.query.harga[i]+"','"+obj.query.result[i].transport_info+"','"+obj.query.result[i].place_info+"')\">ADD TO TRIP</button><br><a href=\"http://localhost/Jaktrip/index.php/PlaceCtr/"+obj.query.result[i].place_name+"\">see details</a></td>";
                            output = output + "</tr>";
         ...
         // alert("ayayaya");
          ...
          for(var i=0; i<itineraryPlaceArray.length; i++)
          {
            if(itineraryPlaceArray[i]!='terhapus' && itineraryPlaceArray[i]!="")
              {
                yangDipilih  = yangDipilih + "<tr><td><img src='http://localhost/Jaktrip/assets/img/50.jpg' class='img-rounded' width='50' height='50'></td><td>"+itineraryPlaceArray[i]+"<br>"+itineraryTotalPriceArray[i]+"<br> <!--a class='toZoom' onclick='return setMapLocationZoom(\""+itineraryPlaceArray[i]+"\")'>see location in map<a--></td><td><a class ='removeTrip'";
                if(isRekomendasi=="true")
                {
                  yangDipilih = yangDipilih + "onclick='return deleteTrip11 (\""+itineraryPlaceArray[i]+"\")' ><span class='glyphicon glyphicon-trash' area-hidden='true' ></span></a></td></tr>";
                 
                }
                else
                {
                  yangDipilih = yangDipilih + "onclick='return deleteTrip1(\""+itineraryPlaceArray[i]+"\")' ><span class='glyphicon glyphicon-trash' area-hidden='true' ></span></a></td></tr>";
                }
     ...
     //       alert(getCookie("idxFirstTrip") + " " + getCookie("idxLastTrip"));
            ...
            yangDipilih = yangDipilih + "<table class='table'><tr><th>Your Trip Cost</th><th>Rp "+tripCost+"</th><th><a href='http://localhost/Jaktrip/index.php/viewTripCtr'><button>view trip</button></a></th></tr></table>"
          ...
          if(countTrip==1)
          {
            ...
            jQuery.ajax({
             ...
             //       alert(obj.query.result[0].place_name);
                    ...
                    output = output + "<td height='20px' class='tuffyh3a'>"+obj.query.result[i].place_name+"<br><div style='font-family:Lato; font-size:14px;'>Rp "+obj.query.harga[i]+" - Indoor Play - "+obj.query.result[i].city+"</span><br>"+obj.query.hargaBusway[i]+" (harga busway) + "+obj.query.result[i].transport_price+" (harga angkot) + "+ticketprice+" (harga tiket)<br><br><button class='btn btn-warning' onclick=\"addTrip1('"+obj.query.result[i].place_name+"','"+obj.query.result[i].halte_name+"','"+obj.query.hargaBusway[i]+"','"+obj.query.result[i].transport_price+"','"+ticketprice+"','"+obj.query.harga[i]+"','"+obj.query.result[i].transport_info+"','"+obj.query.result[i].place_info+"')\">ADD TO TRIP</button><br><a href=\"http://localhost/Jaktrip/index.php/PlaceCtr/"+obj.query.result[i].place_name+"\">see details</a></td>";
