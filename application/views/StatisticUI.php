	<div class="col-lg-12" style="background-color: #fff;">
		<div class="tuffyh2a admintitle">Statistics</div>
		
		<div class="col-lg-2"></div>

		<div class="col-lg-8">
			<ul class="nav nav-pills fak">
				<li id="livis"><a href="#visitors">By Visitors</a></li>
				<li id="lirat"><a href="#rating">By Rating</a></li>
				<li id="libud"><a href="#budget">By Budget</a></li>
			</ul>			
			<br><br>
