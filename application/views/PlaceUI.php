<div class="row" style="background-color: #fff">
	<div class="col-lg-12">
		...
		<div class="col-lg-10">
		    ...
		    <span class="fa fa-heart icondetail"></span>
		    
		</div><br><br>
		<ul id="main-menu" class="sm sm-clean submenu nav navbar-nav detail" style="margin: 0px 0px; border-top: 1px solid #c4c4c4;">
			<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
				...
				$attributes = array('id' => 'addrevform');
					...
					echo "<div class='reviewmember col-lg-12'>";				
						...
						echo "<div class='reviewkanan col-lg-8' style='margin-left:-20px; padding-top: 10px;'>";
							...
							if ($row->rate == 5)
							{echo "<span class='fa fa-star' style='color: #F7E51E'></span><span class='fa fa-star' style='color: #F7E51E'></span><span class='fa fa-star' style='color: #F7E51E'></span><span class='fa fa-star' style='color: #F7E51E'></span><span class='fa fa-star' style='color: #F7E51E'></span>";}
						   echo	"<a href='javascript:deleteFunction(".'"'.$row->id_rate.'","'.$row->place_name.'"'.")'><span class='deleterev close fa fa-trash-o' id='nilaiid' value=''></span></a>";	
	...
	?></div>
					...
					<!--div class="reviewbox col-lg-12">
						...
						<div class="reviewkanan col-lg-6" style="margin-left:-20px; padding-top: 10px;">
