...
<script>	
				...
				if (res){
					...
					for (var i=0 ; i<obj.query.length; i++){
						if(obj.query[i].is_publish == 0){
							resultQuery = resultQuery +  "<tr><td>"+obj.query[i].place_name+"</td><td>"+obj.query[i].pic+"</td><td></td><td><a href='javascript:setphotopublish("+obj.query[i].id_pic+")'>&nbsp;&nbsp;Publish?</a></td>";
						}else{
							resultQuery = resultQuery +  "<tr><td>"+obj.query[i].place_name+"</td><td>"+obj.query[i].pic+"</td><td></td><td><a href='javascript:setphotounpublish("+obj.query[i].id_pic+")'>&nbsp;&nbsp;Unpublish?</a></td>";
						}
					}
	...
	function setphotounpublish(id_pic){		
		jQuery.ajax({
	        type: "POST",
	        url: "http://localhost/JAKtrip/index.php/SuggestionCtr/unpublish/"+id_pic,
	        success: function(res){
				if (res){
					var obj = jQuery.parseJSON(res);
					var resultQuery = "";
